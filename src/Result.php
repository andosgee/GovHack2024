...
if ($googleSolarRequest !== false):
    ...
    <p>According to Google the roof at <?php echo $address ?> has:</p>
    <ul>
    ...
    <p>The amount of panel area entered was <?php echo $areaOfPanels?>m<sup>2</sup> which is <?php echo number_format($maxArrayArea - $areaOfPanels,2)?>m<sup>2</sup> off the max predicted by Google Solar API</p>
<?php endif; ?>
